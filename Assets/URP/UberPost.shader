Shader "Hidden/Universal Render Pipeline/UberPost2"
{
    HLSLINCLUDE
        ...
        half4 Frag(Varyings input) : SV_Target
        {
            ...
            half3 color = (0.0).xxx;
            float alpha = SAMPLE_TEXTURE2D_X(_SourceTex, sampler_LinearClamp, uv).w;
            ...
            #if defined(BLOOM)
            {
                ...
                #endif
                // alpha = max(max(max(color.r, color.g), color.b), alpha);
            }
            #endif
